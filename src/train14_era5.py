...
class DatasetFromFolder(Dataset):
    ...
    def __init__(
        ...
        # ---- Fixed split boundaries (mirrors finetune_entire.py config) ----
        # train : 2023-01-01 → 2025-12-31
        # valid : 2026-01-01 → 2026-03-31
        # test  : 2026-04-01 → 2026-05-26
        ...
        self.surface_transform, self.surface_variables = surface_transform(
            join(dataset_dir, "aux_data", "surface_mean.npy"),
            join(dataset_dir, "aux_data", "surface_std.npy")
        )
        self.upper_air_transform, self.upper_air_variables, self.upper_air_pLevels = upper_air_transform(
            join(dataset_dir, "aux_data", "upper_mean.npy"),
            join(dataset_dir, "aux_data", "upper_std.npy")
        )
